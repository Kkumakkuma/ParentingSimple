"""
ParentingSimple - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Kids Activity Planner", "price": "$6.99", "slug": "kids-planner", "desc": "200+ activity ideas organized by age, type, and season."},
    {"name": "Family Routine Organizer", "price": "$6.99", "slug": "family-routine", "desc": "Morning/evening routines, chore charts, and family calendar."},
]

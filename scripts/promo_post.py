"""
ParentingSimple - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "price": "$6.99",
        "slug": "kids-activity",
        "desc": "Plan fun, educational activities for your kids with our Notion planner.",
        "keywords": ["kids activities", "family planning", "educational activities", "screen-free fun"],
    },
    {
        "name": "Family Routine Organizer",
        "price": "$6.99",
        "slug": "family-routine",
        "desc": "Create smooth daily routines for your whole family.",
        "keywords": ["family routine", "daily schedule", "morning routine", "bedtime routine"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert parenting writer.
